  ...
  return (
    <footer>
      <Flex justify="space-between" align="center">
        <Text>{repositoryURL && refCommit && deployedAt ? <p>Last deployed on {deployedAt} for commit <a href={refCommitURL}>{refCommit.slice(0, 8)}</a>.</p> : "Build information is unavailable."}</Text>
